<div class="wrap google_routeplaner">
	<div id="icon-google_routeplaner" class="icon32"><br /></div><h2><?php _e('Google Routeplanner', 'google_routeplaner'); ?> &bull; <?php _e('Troubleshooting', 'google_routeplaner'); ?></h2>
	<div id="poststuff">
		<div class="postbox">
			...
			<div class="inside">
				...
				<p><?php _e('This is most of the time caused by your theme and sadly this is also the case with the <em>Twenty Eleven</em>.', 'google_routeplaner'); ?></p>
