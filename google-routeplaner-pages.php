   ...
   <?php
	if(is_array($planers)) {
		foreach($planers as $planer) {
			...
			<td>
			<a href="admin.php?page=google_routeplaner_routes&routeplaner_action=preview_route&route_id=' . $planer['planer_id'] . '">' . __('preview', 'google_routeplaner') . '</a>
...
function google_routeplaner_preview_route($route_id) {
	...
	<div class="wrap google_routeplaner">
    <h2><?php _e('Google Routeplaner', 'google_routeplaner'); ?> &bull; <?php _e('Preview Route', 'google_routeplaner'); ?></h2>
	<p><a href="admin.php?page=google_routeplaner_routes"><?php _e('Back to overview', 'google_routeplaner'); ?></p>
